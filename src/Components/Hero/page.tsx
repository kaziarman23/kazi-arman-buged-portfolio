...
const Hero = () => {
  return (
    <div id="About" className={`${lora.className} w-full h-screen text-white`}>
      {/* <Spotlight
      ...
      <div className="w-4/5 h-full mx-auto flex justify-center items-center">
        <div className="w-1/2 min-h-1/2 space-y-3">
          <h1 className="text-center text-7xl mt-16 font-bold hover:text-blue-500">Kazi Arman</h1>
          ...
          <div className="p-4 flex justify-center gap-2 items-center">
            <Link href="#Contact">
              <button className="px-6 py-3 bg-black text-white border-2 rounded-2xl hover:bg-white hover:text-black">
                Quick Contact
              </button>
            </Link>
            <ResumeBtn />
